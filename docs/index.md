# NI Automotive Camera Module Documentation
...
### Common
- [PXIe-148X Getting Started Example - SerDes Configuration Script Tutorial](tutorials/gettingstartedexample/gse-serdes-config-script.md)
